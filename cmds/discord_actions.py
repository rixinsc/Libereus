...
from core.helper import cmderr, logger
import discord
import typing
...
class DiscordActions(ExtensionBase, name="Discord Actions"):
        ...
        async def kick(self, ctx, members: commands.Greedy[discord.Member], *, reason: str = 'N/A'):
                ...
                for m in members:
                        ...
                        logger.info('{name} has been kicked | Reason: {reason}'.format(name=m.name, reason=reason))
        ...
        async def ban(self, ctx, members: commands.Greedy[discord.Member], *, reason: str = "N/A"):
                ...
                for m in members:
                        ...
                        logger.info('{name} has been ban | Reason: {reason}'.format(name=m.name, reason=reason))
        ...
        async def softban(self, ctx, members: commands.Greedy[discord.Member], *, reason: str = "N/A"):
                ...
                for m in members:
                        ...
                        logger.info('{name} has been timeout | Reason: {reason}'.format(name=m.name, reason=reason))
        ...
        async def forceban(self, ctx, uids: commands.Greedy[int], reason: str = "N/A"):
                ...
                for uid in uids:
                        ...
                        logger.info("{name}#{ID} has been blocked | Reason: {reason}".format(name=user.name, ID=user.id, reason=reason))
        ...
        async def voicekick(self, ctx, members: commands.Greedy[typing.Union[discord.Member, discord.Role]], reason = "N/A"):
                """kick the member out of the channel"""
